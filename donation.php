    ...
    <div class="space-extra2-top space-extra2-bottom" data-bg-src="assets/img/hero/menu33.jpeg">
        <div class="container">
            <div class="row flex-row-reverse justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <div>
                        <form class="contact-form style2">
                            <h3 class="sec-title mb-30 text-capitalize">donation</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <select name="subject" id="subject" class="form-select nice-select" itemid="sec">
                                        <option value="Select Tour Type" selected="selected" disabled="disabled">money</option>
                                        <option>+ 10dt</option>
                                        <option>+ 20dt</option>
                                        <option>+ 50dt</option>
                                        <option>+ 100dt</option>
                                ...
                                <div class="form-btn col-12 mt-24">
                                    <button type="button" class="th-btn style3" onclick="handleDonationClick(event)">Send money <img src="assets/img/icon/plane.svg" alt=""></button>
                                </div>
                            </div>
