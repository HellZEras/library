    ...
    <div class="space-extra2-top space-extra2-bottom" data-bg-src="assets/img/hero/menu33.jpeg">
        <div class="container">
            <div class="row flex-row-reverse justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <div>
                        <form action="/libary/php/donation.php" method="POST" class="contact-form style2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group"><input type="email" class="form-control" name="email"
                                        id="email" placeholder="Your Mail"> <img src="assets/img/icon/mail.svg" alt="">
                                </div>
                                <div class="form-group col-12"><select name="subject" id="subject"
                                        class="form-select nice-select" itemid="sec">
                                        <option value="Select Tour Type" selected="selected" disabled="disabled">money
                                        </option>
                                        <option>+ 10dt</option>
                                        <option>+ 20dt</option>
                                        <option>+ 50dt</option>
                                ...
                                <div class="form-btn col-12 mt-24">
                                    <button type="submit" class="th-btn style3">Send money <img
