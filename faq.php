        ...
        <div class="menu-area">
            <div class="container th-container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="header-logo"><a href="index_adult.php"><img src="assets/images/spl-stickylogo.png"
                                    alt="Tourm"></a></div>
                    </div>
                                        ...
                                        <li>
                                            <div class="container">
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="mega-menu-box">
                                                            <div class="mega-menu-img"><img src="assets/images/pic2.png"
                                                                    alt="Home Two">
                                                                <div class="btn-wrap"><a target="_blank"
...
<div class="space-top space-extra-bottom">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-7">
                <div class="title-area text-center"><span class="sub-title">FAQ</span>
                ...
                <div class="accordion-area accordion mb-30" id="faqAccordion">
                    <div class="accordion-card style2 active">
                        <div class="accordion-header" id="collapse-item-1"><button class="accordion-button"
                                ...
                                aria-expanded="true" aria-controls="collapse-1">Q1. How can I borrow books from the
                                library?</button></div>
                        <div id="collapse-1" class="accordion-collapse collapse show" aria-labelledby="collapse-item-1"
                            ...
                            <div class="accordion-body style2">
                                <p class="faq-text">To borrow books, you need to be a registered library member.
                                    Just bring the book to the checkout
                                    desk with your membership card, or use our self-service checkout machines.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-2"><button class="accordion-button collapsed"
                                ...
                                aria-expanded="false" aria-controls="collapse-2">Q2.
                                What are the library’s opening hours?</button></div>
                        <div id="collapse-2" class="accordion-collapse collapse" aria-labelledby="collapse-item-2"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">Our library is open from Monday to Friday, 9:00 AM to 7:00 PM,
                                    and Saturday, 10:00 AM to 5:00 PM. We are closed on Sundays and public holidays.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-3"><button class="accordion-button collapsed"
                                ...
                                aria-expanded="false" aria-controls="collapse-3">Q3.
                                How do I renew a borrowed book?</button></div>
                        <div id="collapse-3" class="accordion-collapse collapse" aria-labelledby="collapse-item-3"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">You can renew books online through your library account, by
                                    phone, or by visiting the library in person. Renewals are subject to the book
                                    not being reserved by another user.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-4"><button class="accordion-button collapsed"
                                ...
                                aria-expanded="false" aria-controls="collapse-4">Q4.
                                Are there late fees for overdue books?</button></div>
                        <div id="collapse-4" class="accordion-collapse collapse" aria-labelledby="collapse-item-4"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">Yes, a small fee is charged for overdue books to encourage
                                    timely returns. The fee varies based on the type of book and how overdue it is.
                                    Please refer to our fee schedule or contact us for details.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-5"><button class="accordion-button collapsed"
                                ...
                                aria-expanded="false" aria-controls="collapse-5">Q5.
                                How do I reserve a book that’s currently checked out?</button></div>
                        <div id="collapse-5" class="accordion-collapse collapse" aria-labelledby="collapse-item-5"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">You can reserve a book online through your library account or by
                                    speaking to a librarian. We’ll notify you when the book becomes available for
                                    pickup.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-6"><button class="accordion-button collapsed"
                                type="button" data-bs-toggle="collapse" data-bs-target="#collapse-6"
                                aria-expanded="false" aria-controls="collapse-6">Q6.
                                Does the library offer digital books or audiobooks?</button></div>
                        <div id="collapse-6" class="accordion-collapse collapse" aria-labelledby="collapse-item-6"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">Yes, we provide a selection of e-books and audiobooks that can
                                    be accessed through our digital library. All you need is an active membership
                                    and our library app to get started.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-7"><button class="accordion-button collapsed"
                                ...
                                aria-expanded="false" aria-controls="collapse-7">Q7.
                                How can I negotiate the best price when buying a property?</button></div>
                        <div id="collapse-7" class="accordion-collapse collapse" aria-labelledby="collapse-item-7"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">Absolutely! You can make a purchase suggestion by filling out
                                    our "Request a Book" form, and we’ll do our best to add it to our collection if
                                    possible.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-8"><button class="accordion-button collapsed"
                                ...
                                aria-expanded="false" aria-controls="collapse-8">Q8.
                                Are there any membership fees for joining the library?</button></div>
                        <div id="collapse-8" class="accordion-collapse collapse" aria-labelledby="collapse-item-8"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">Basic membership is free for residents. However, some additional
                                    services or premium memberships may have a small fee. Please visit our
                                    membership page for more details.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-9"><button class="accordion-button collapsed"
                                ...
                                aria-expanded="false" aria-controls="collapse-9">Q9.
                                How can I access the library’s online catalog?</button></div>
                        <div id="collapse-9" class="accordion-collapse collapse" aria-labelledby="collapse-item-9"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">Our online catalog is accessible via our website. Simply log in
                                    with your membership details, and you can search, reserve, and renew books
                                    directly.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-card style2">
                        <div class="accordion-header" id="collapse-item-10"><button class="accordion-button collapsed"
                                type="button" data-bs-toggle="collapse" data-bs-target="#collapse-10"
                                aria-expanded="false" aria-controls="collapse-10">Q10.
                                What resources are available for research or academic study?</button></div>
                        <div id="collapse-10" class="accordion-collapse collapse" aria-labelledby="collapse-item-10"
                            data-bs-parent="#faqAccordion">
                            <div class="accordion-body style2">
                                <p class="faq-text">We offer access to academic journals, research databases, and
                                    reference materials, both in print and online. Our librarians are also available
                                    to help you with research questions and finding materials.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="bg-top-center space overflow-hidden" data-bg-src="assets/img/bg/tour_bg_3.jpg">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-11">
                <div class="">
                    <div class="title-area text-center mb-30"><span class="sub-title style1">Meet with Our
                            Guide</span>
                    ...
                    <form action="https://html.themeholy.com/tourm/demo/mail.php" method="POST"
                        ...
                        <h3 class="sec-title mb-30">Questions ?</h3>
                        <div class="row">
                            <div class="col-md-6 form-group"><input type="text" class="form-control" name="name"
                                    id="name3" placeholder="First Name"> <img src="assets/img/icon/user.svg" alt="">
                            </div>
                            <div class="col-md-6 form-group"><input type="email" class="form-control" name="email3"
                            ...
                            <div class="form-group col-12"><select name="subject" id="subject"
                                    ...
                                    <option value="Select Tour Destination" selected="selected" disabled="disabled">
                                        Select Tour Destination</option>
                        ...
                        <div class="th-widget-contact">
                            ...
                            <div class="info-box_text">
                                ...
                                <div class="details">
                                    ...
                                    <p><a href="mailto:support24@tourm.com" class="info-box_link">support2@gmail.com</a>
                                    </p>
                                </div>
                            </div>
                            <div class="info-box_text">
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-6 text-end d-none d-md-block">
                    <div class="footer-card"><span class="title">We Accept</span> <img src="assets/img/shape/cards.png"
                            alt=""></div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from html.themeholy.com/tourm/demo/faq.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Oct 2024 04:01:58 GMT -->
