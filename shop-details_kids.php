    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/hero/menu2.jpeg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">book Details</h1>
            ...
            <div class="row gx-60">
                <div class="col-lg-6">
                    <div class="product-big-img">
                        <div class="img"><img src="assets/images/Jacket.jpeg" alt="Product Image"
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        <p class="price">25.00 DT<del>30.00 DT</del></p>
                        <h2 class="product-title">never whistle at night</h2>
                        ...
                        <p class="text">Bluetooth headphones are a popular choice for many people due to their
                            convenience and wireless capabilities. They allow users to listen to music, podcasts, or
                            make calls without being tethered to their device</p>
                        ...
                        <div class="product_meta"><span class="sku_wrapper">id: <span
                                    class="sku">BH-1001-BT</span></span> <span class="posted_in">type: <a
                                    href="shop.php">sports , advanter</a></span> <span>age: -14</span></div>
                    </div>
                </div>
                <ul class="nav product-tab-style2" id="productTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" id="additional-tab"
                            data-bs-toggle="tab" href="#additional" role="tab" aria-controls="additional"
                ...
                <div class="tab-content" id="productTabContent">
                    <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                        <p>Bluetooth headphones are a wireless audio accessory that connects to your devices, like
                            smartphones, tablets, or computers, via Bluetooth technology. Here's a typical description
                            Introducing our [Brand Name] Bluetooth Headphones, the ultimate companion for your on-the-go
                            audio experience. Immerse yourself in high-fidelity sound without the hassle of wires,
                            thanks to
                            the latest Bluetooth technology Featuring [insert standout features such as noise
                            cancellation,
                            long battery life, etc.], our headphones deliver crystal-clear audio while providing
                            unmatched
                            comfort during extended listening sessions. Designed for convenience and portability, our
                            sleek
                            and lightweight headphones fold easily for storage and travel. The adjustable headband
                            ensures a
                            secure and comfortable fit for all head shapes and sizes.</p>
                    </div>
                    <div class="tab-pane fade" id="additional" role="tabpanel" aria-labelledby="additional-tab">
                        <p>Advanced Bluetooth Connectivity: Our headphones utilize the latest Bluetooth technology for
                            seamless pairing with your devices and reliable wireless connectivity up to 30 feet away.
                            Long-lasting Battery Life: Enjoy hours of uninterrupted music playback with our long-lasting
                            rechargeable battery. Whether you're on a long flight or a marathon study session, our
                            headphones have you covered. Immersive Sound Experience: Experience rich, immersive sound
                            with
                            powerful bass and crisp highs. Our headphones are engineered to deliver audio that's true to
                            the
                            artist's intention, whether you're listening to music, podcasts, or watching movies.
                            Comfortable
                            Ergonomic Design: Designed for extended wear, our headphones feature plush ear cushions and
                            an
                            adjustable headband for a comfortable fit. Say goodbye to discomfort, even during marathon
                            listening sessions. Foldable and Portable: Our headphones are designed to go wherever you
                            do.
                            Easily fold them up and toss them in your bag for on-the-go convenience. Whether you're
                            traveling, commuting, or hitting the gym, take your music with you everywhere. Intuitive
                            Controls: Control your music, adjust volume, and take calls with ease using the intuitive
                                    ...
                                    <li class="review th-comment-item">
                                        <div class="th-post-comment">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <p class="text">This product is very much qualityful and I love this
                                                    working
                                                    system and speed.</p>
                                            </div>
                                        </div>
                                    ...
                                    <li class="review th-comment-item">
                                        <div class="th-post-comment">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <p class="text">They delivered the product in a few time. Product
                                                    quality is
                                                    also very good.</p>
                                            </div>
                                        </div>
                                    ...
                                    <li class="review th-comment-item">
                                        <div class="th-post-comment">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <p class="text">I am just in love with this product. Their service is
                                                    also
                            ...
                            <div class="th-comment-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 form-group"><textarea placeholder="Write a Message"
                                            ...
                                            class="text-title far fa-pencil-alt"></i>
                                    </div>
                                    ...
                                    <div class="col-12 form-group"><input id="reviewcheck" name="reviewcheck"
                                            type="checkbox"> <label for="reviewcheck">Save my name, email, and website
                                            in
                                            this browser for the next time I comment.<span
                                                class="checkmark"></span></label>
                                    </div>
                                    <div class="col-12 form-group mb-0"><button class="th-btn">Post Review</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from html.themeholy.com/tourm/demo/shop-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Oct 2024 04:01:47 GMT -->
